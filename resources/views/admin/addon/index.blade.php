                                        ...
                                        <div class="col-md-3">
                                            <div class="card card-custom">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h5 class="card-title">{{str_limit($addon->title,45)}}</h5>
                                                    <p class="card-text">{{str_limit($addon->description,100)}}</p>
                                                    @can('addons_delete')
                                                        <a href="#" id="DeleteModalClick"  data-attr="{{ route('admin.addons.destroy', $addon->id) }}" data-title="{{$addon->title}}" title="Delete Addon" class="btn btn-block btn-danger">{{ __('Remove') }}</a>
                                                    @endcan
                                                </div>
                                            </div>
                                        </div>
                ...
                <div>
                    <form id="deleteForm"  method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-danger">{{ __('Yes, Delete Addon') }}</button>
                        </div>
                    </form>
                </div>
            </div>
