                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-12 col-12">
                                        <label for="old_password">{{ __('profile.old_password') }}</label> <span class="text-danger">*</span>
                                    ...
                                    <div class="form-group col-md-12 col-12">
                                        <label for="password">{{ __('profile.password') }}</label> <span class="text-danger">*</span>
                                    ...
                                    <div class="form-group col-md-12 col-12">
                                        <label for="password_confirmation">{{ __('profile.password_confirmation') }}</label> <span class="text-danger">*</span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        @endif
                                        <img class="img-thumbnail image-width mt-4 mb-3" id="previewImage" src="{{ $user->images }}" alt="{{ $user->name }} {{ __('profile.profile_image') }}"/>
                                    </div>
                                    <div class="form-group col">
